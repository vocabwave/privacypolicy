...
function lightMode() {
    lightmodeBTN.style.backgroundImage = 'url(https://vocabwave.github.io/privacypolicy/Files/sun.png)';
    document.head.appendChild(sty);
}
function darkMode() {
    lightmodeBTN.style.backgroundImage = 'url(https://vocabwave.github.io/privacypolicy/Files/moon.png)';
